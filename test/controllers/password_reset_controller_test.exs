defmodule Zizhixi.PasswordResetControllerTest do
  use Zizhixi.ConnCase

  alias Zizhixi.PasswordReset
  @valid_attrs %{}
  @invalid_attrs %{}
  ...
  test "renders page not found when id is nonexistent", %{conn: conn} do
    assert_error_sent 404, fn ->
      get conn, password_reset_path(conn, :show, "11111111-1111-1111-1111-111111111111")
    end
  end
